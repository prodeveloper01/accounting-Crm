...
class Stockreturn_model extends CI_Model
{
    ...
    public function purchase_details($id)
    {
        ...
        $this->db->select('stock_return.*,supplier.*,supplier.id AS cid,billing_terms.id AS termid,billing_terms.title AS termtit,billing_terms.terms AS terms');
        $this->db->from($this->table);
        $this->db->where('stock_return.tid', $id);
        $this->db->join('supplier', 'stock_return.csd = supplier.id', 'left');
        $this->db->join('billing_terms', 'billing_terms.id = stock_return.term', 'left');
        $query = $this->db->get();
    ...
    public function purchase_delete($id)
    {
        ...
        $this->db->delete('stock_return', array('tid' => $id));
        $this->db->delete('stock_return_items', array('tid' => $id));
