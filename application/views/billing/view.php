                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group mt-2"><?php echo $this->lang->line('Payment') ?>:
                                            <?php if ($online_pay['enable'] == 1) {
                                              echo '<a class="btn btn-success btn-min-width mr-1" href="#' . base_url('billing/card?id=' . $invoice['tid'] . '&itype=inv&token=' . $token) . '" data-toggle="modal" data-target="#paymentCard"><i class="fa fa-cc"></i> Credit Card</a> ';
                                            }
                                        ...
                                        <div class="btn-group mt-2">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                   href="<?php echo 'printinvoice?id=' . $invoice['tid'] . '&token=' . $token; ?>"><?php echo $this->lang->line('Print') ?></a>
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item"
                                                   href="<?php echo 'printinvoice?id=' . $invoice['tid'] . '&token=' . $token; ?>&d=1"><?php echo $this->lang->line('PDF Download') ?></a>
